...
void Modify()
{
    ...
    {
        printf("Enter the new name or the old one (if you don't want to change it): ");
        getchar();
        gets(A[i].name);
        ...
        printf("Enter the new Email or the old one (if you don't want to change it): ");
        scanf("%s",A[i].email);
        ...
        printf("Enter the new mobile number or the old one (if you don't want to change it): ");
        scanf("%s",A[i].mobile);
